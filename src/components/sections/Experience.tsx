...
const experiences = [
  {
    ...
    technologies: [
      ...
      {
        name: "Firebase",
        icon: "https://ik.imagekit.io/shubhampathak/portfolio/icons/firebase-plain.svg",
      },
      {
        name: "Vercel",
  ...
  },
  {
    ...
    technologies: [
      {
        name: "HTML5",
        icon: "https://ik.imagekit.io/shubhampathak/portfolio/icons/html5-original.svg",
      },
      {
        name: "CSS3",
        icon: "https://ik.imagekit.io/shubhampathak/portfolio/icons/css3-original.svg",
      },
      {
        name: "JavaScript",
        icon: "https://ik.imagekit.io/shubhampathak/portfolio/icons/javascript-original.svg",
      },
      {
        name: "React",
        icon: "https://ik.imagekit.io/shubhampathak/portfolio/icons/react-original.svg",
                      ...
                      <div>
                        ...
                        <div className="flex gap-3 flex-wrap px-2">
                          {exp.technologies.map((tech) => (
                            <div
                              key={`${exp.id}-${tech.name}`}
                              className="relative w-10 h-10 flex items-center justify-center"
                            >
                              <motion.button
                                type="button"
                                onMouseEnter={() =>
                                  setHoveredTech(`${exp.id}-${tech.name}`)
                                }
